  ...
  public final float getInterpolation(float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        f = (paramFloat - i * STEP_SIZE) / STEP_SIZE;
        paramFloat = VALUES[i];
        paramFloat = (VALUES[(i + 1)] - VALUES[i]) * f + paramFloat;
      }
    }
  }
}
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/android/support/v4/widget/BakedBezierInterpolator.class
