  ...
  extends ResourceCursorAdapter
{
  ...
  public void bindView(View paramView, Context paramContext, Cursor paramCursor)
  {
    ...
    if (i < j)
    {
      localView = paramView.findViewById(arrayOfInt1[i]);
      if (localView != null) {
    ...
    label147:
    label182:
    for (boolean bool = localViewBinder.setViewValue(localView, paramCursor, arrayOfInt2[i]);; bool = false)
    {
      if (!bool)
      {
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/android/support/v4/widget/SimpleCursorAdapter.class
