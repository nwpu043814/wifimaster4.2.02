...
final class SwipeProgressBar
{
  ...
  final void draw(Canvas paramCanvas)
  {
    ...
    if ((this.mRunning) || (this.mFinishTime > 0L))
    {
      ...
      l1 = (l3 - this.mStartTime) / 2000L;
      f1 = (float)((l3 - l2) % 2000L) / 20.0F;
      if (this.mRunning) {
        break label603;
      }
      ...
      float f3 = (float)((l3 - this.mFinishTime) % 1000L) / 10.0F / 100.0F;
      f2 = k;
      f2 = INTERPOLATOR.getInterpolation(f3) * f2;
      this.mClipRect.set(k - f2, 0.0F, f2 + k, j);
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/android/support/v4/widget/SwipeProgressBar.class
