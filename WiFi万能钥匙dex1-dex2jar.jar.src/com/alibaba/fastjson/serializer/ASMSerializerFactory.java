  ...
  implements Opcodes
{
  ...
  private void _if_write_null(MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, Context paramContext)
  {
    ...
    {
      localObject = paramFieldInfo.serialzeFeatures();
      ...
      if (i1 < i7)
      {
        paramFieldInfo = localObject[i1];
        if (paramFieldInfo == SerializerFeature.WriteMapNullValue)
        {
          i4 = 1;
          i5 = j;
          i3 = k;
        ...
        for (;;)
        {
          ...
          else if (paramFieldInfo == SerializerFeature.WriteNullStringAsEmpty)
          {
            i3 = 1;
            i2 = m;
            i5 = j;
          ...
          else
          {
            ...
            i5 = j;
            i4 = i;
            if (paramFieldInfo == SerializerFeature.WriteNullListAsEmpty)
            {
              n = 1;
              i2 = m;
              i3 = k;
  ...
  private void _list(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, Context paramContext)
  {
    ...
    label1295:
    label1520:
    for (Class localClass = (Class)paramClass;; localClass = null)
    {
      Label localLabel1 = new Label();
  ...
  private void generateWriteAsArray(Class<?> paramClass, MethodVisitor paramMethodVisitor, List<FieldInfo> paramList, Context paramContext)
  {
    ...
    label705:
    Object localObject = paramClass.getFormat();
    paramMethodVisitor.visitVarInsn(25, paramContext.serializer());
    _get(paramMethodVisitor, paramContext, paramClass);
    if (localObject != null)
    {
  ...
  private void generateWriteMethod(Class<?> paramClass, MethodVisitor paramMethodVisitor, List<FieldInfo> paramList, Context paramContext)
  {
    ...
    paramMethodVisitor.visitJumpInsn(199, (Label)localObject1);
    ...
    paramMethodVisitor.visitJumpInsn(165, (Label)localObject1);
    paramMethodVisitor.visitLabel(localLabel2);
    paramMethodVisitor.visitVarInsn(25, paramContext.var("out"));
  ...
  public ObjectSerializer createJavaBeanSerializer(Class<?> paramClass, Map<String, String> paramMap)
  {
    ...
    {
      localObject3 = (FieldInfo)((Iterator)localObject4).next();
      ((MethodVisitor)localObject2).visitVarInsn(25, 0);
      ((MethodVisitor)localObject2).visitLdcInsn(Type.getType(ASMUtils.getDesc(((FieldInfo)localObject3).getDeclaringClass())));
      if (((FieldInfo)localObject3).getMethod() != null)
      {
        ((MethodVisitor)localObject2).visitLdcInsn(((FieldInfo)localObject3).getMethod().getName());
      ...
      for (;;)
      {
        ((MethodVisitor)localObject2).visitFieldInsn(181, str, ((FieldInfo)localObject3).getName() + "_asm_fieldType", "Ljava/lang/reflect/Type;");
        break;
        ((MethodVisitor)localObject2).visitLdcInsn(((FieldInfo)localObject3).getField().getName());
    ...
    Object localObject3 = new Context(str);
    localObject2 = localClassWriter.visitMethod(1, "write", "(Lcom/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V", null, new String[] { "java/io/IOException" });
    ((MethodVisitor)localObject2).visitVarInsn(25, ((Context)localObject3).serializer());
    ...
    ((MethodVisitor)localObject2).visitVarInsn(58, ((Context)localObject3).var("out"));
    localObject4 = (JSONType)paramClass.getAnnotation(JSONType.class);
    if ((localObject4 == null) || (((JSONType)localObject4).alphabetic()))
    {
      localObject4 = new Label();
      ((MethodVisitor)localObject2).visitVarInsn(25, ((Context)localObject3).var("out"));
      ((MethodVisitor)localObject2).visitFieldInsn(178, ASMUtils.getType(SerializerFeature.class), "SortField", "L" + ASMUtils.getType(SerializerFeature.class) + ";");
      ((MethodVisitor)localObject2).visitMethodInsn(182, ASMUtils.getType(SerializeWriter.class), "isEnabled", "(L" + ASMUtils.getType(SerializerFeature.class) + ";)Z");
      ((MethodVisitor)localObject2).visitJumpInsn(153, (Label)localObject4);
      ((MethodVisitor)localObject2).visitVarInsn(25, 0);
      ...
      ((MethodVisitor)localObject2).visitVarInsn(25, ((Context)localObject3).paramFieldType());
      ((MethodVisitor)localObject2).visitMethodInsn(182, str, "write1", "(Lcom/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V");
      ((MethodVisitor)localObject2).visitInsn(177);
      ((MethodVisitor)localObject2).visitLabel((Label)localObject4);
    }
    ((MethodVisitor)localObject2).visitVarInsn(25, ((Context)localObject3).obj());
    ((MethodVisitor)localObject2).visitTypeInsn(192, ASMUtils.getType(paramClass));
    ((MethodVisitor)localObject2).visitVarInsn(58, ((Context)localObject3).var("entity"));
    generateWriteMethod(paramClass, (MethodVisitor)localObject2, (List)localObject1, (Context)localObject3);
    ((MethodVisitor)localObject2).visitInsn(177);
    ((MethodVisitor)localObject2).visitMaxs(5, ((Context)localObject3).getVariantCount() + 1);
    ((MethodVisitor)localObject2).visitEnd();
    paramMap = TypeUtils.computeGetters(paramClass, paramMap, true);
    localObject2 = new Context(str);
    localObject1 = localClassWriter.visitMethod(1, "write1", "(Lcom/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V", null, new String[] { "java/io/IOException" });
    ((MethodVisitor)localObject1).visitVarInsn(25, ((Context)localObject2).serializer());
    ((MethodVisitor)localObject1).visitMethodInsn(182, ASMUtils.getType(JSONSerializer.class), "getWriter", "()" + ASMUtils.getDesc(SerializeWriter.class));
    ((MethodVisitor)localObject1).visitVarInsn(58, ((Context)localObject2).var("out"));
    ((MethodVisitor)localObject1).visitVarInsn(25, ((Context)localObject2).obj());
    ((MethodVisitor)localObject1).visitTypeInsn(192, ASMUtils.getType(paramClass));
    ((MethodVisitor)localObject1).visitVarInsn(58, ((Context)localObject2).var("entity"));
    generateWriteMethod(paramClass, (MethodVisitor)localObject1, paramMap, (Context)localObject2);
    ((MethodVisitor)localObject1).visitInsn(177);
    ((MethodVisitor)localObject1).visitMaxs(5, ((Context)localObject2).getVariantCount() + 1);
    ((MethodVisitor)localObject1).visitEnd();
    localObject2 = new Context(str);
    localObject1 = localClassWriter.visitMethod(1, "writeAsArray", "(Lcom/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V", null, new String[] { "java/io/IOException" });
    ((MethodVisitor)localObject1).visitVarInsn(25, ((Context)localObject2).serializer());
    ((MethodVisitor)localObject1).visitMethodInsn(182, ASMUtils.getType(JSONSerializer.class), "getWriter", "()" + ASMUtils.getDesc(SerializeWriter.class));
    ((MethodVisitor)localObject1).visitVarInsn(58, ((Context)localObject2).var("out"));
    ((MethodVisitor)localObject1).visitVarInsn(25, ((Context)localObject2).obj());
    ((MethodVisitor)localObject1).visitTypeInsn(192, ASMUtils.getType(paramClass));
    ((MethodVisitor)localObject1).visitVarInsn(58, ((Context)localObject2).var("entity"));
    generateWriteAsArray(paramClass, (MethodVisitor)localObject1, paramMap, (Context)localObject2);
    ((MethodVisitor)localObject1).visitInsn(177);
    ((MethodVisitor)localObject1).visitMaxs(5, ((Context)localObject2).getVariantCount() + 1);
    ((MethodVisitor)localObject1).visitEnd();
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/alibaba/fastjson/serializer/ASMSerializerFactory.class
