...
public class SerialWriterStringEncoder
{
  ...
  {
    if (paramInt2 == 0) {}
    for (paramArrayOfChar = new byte[0];; paramArrayOfChar = encode(paramArrayOfChar, paramInt1, paramInt2, ThreadLocalCache.getBytes(scale(paramInt2, this.encoder.maxBytesPerChar()))))
    {
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/alibaba/fastjson/serializer/SerialWriterStringEncoder.class
