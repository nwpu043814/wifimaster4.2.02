...
public final class a
{
  ...
  public static a a()
  {
    try
    {
      if (i == null)
      {
        locala = new com/lantern/photochoose/b/a;
        locala.<init>();
        i = locala;
      }
      a locala = i;
  ...
  private void a(a parama)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 146	com/lantern/photochoose/b/a:g	Landroid/os/Handler;
    //   6: ifnonnull +10 -> 16
    //   9: aload_0
    //   10: getfield 51	com/lantern/photochoose/b/a:h	Ljava/util/concurrent/Semaphore;
    //   13: invokevirtual 157	java/util/concurrent/Semaphore:acquire	()V
    //   16: aload_0
    //   17: getfield 95	com/lantern/photochoose/b/a:c	Ljava/util/LinkedList;
    //   20: aload_1
    //   21: invokevirtual 161	java/util/LinkedList:add	(Ljava/lang/Object;)Z
    //   24: pop
    //   25: aload_0
    //   26: getfield 146	com/lantern/photochoose/b/a:g	Landroid/os/Handler;
    //   29: iconst_0
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/lantern/photochoose/b/a.class
