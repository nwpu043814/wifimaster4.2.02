...
import com.lantern.photochoose.ui.a.a;
  ...
  implements AdapterView.OnItemClickListener
{
  ...
  {
    paramAdapterView = (com.lantern.photochoose.a.b)this.a.get(paramInt);
    if (paramAdapterView.a()) {
      return;
    }
    paramView = this.a.iterator();
    while (paramView.hasNext()) {
      ((com.lantern.photochoose.a.b)paramView.next()).a(false);
    }
    paramAdapterView.a(true);
    this.b.notifyDataSetChanged();
    PhotoPickerFragment.c(this.c).clear();
    PhotoPickerFragment.c(this.c).addAll(paramAdapterView.c());
    if (PhotoPickerFragment.e().equals(paramAdapterView.b())) {
    ...
    for (;;)
    {
      ...
      PhotoPickerFragment.i(this.c).setText(paramAdapterView.b());
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/lantern/photochoose/ui/c.class
