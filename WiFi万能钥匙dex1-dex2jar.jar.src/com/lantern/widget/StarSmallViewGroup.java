...
public class StarSmallViewGroup
  extends RelativeLayout
{
  private View a;
  private TextView b;
  
  public StarSmallViewGroup(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public StarSmallViewGroup(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    this.a = LayoutInflater.from(paramContext).inflate(R.layout.stars_small_layout, this);
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/lantern/widget/StarSmallViewGroup.class
