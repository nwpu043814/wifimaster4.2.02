...
public final class c
{
  ...
  public final void a(String paramString, Bitmap paramBitmap)
  {
    try
    {
      ...
      if (this.b > this.c)
      {
        paramBitmap = this.a.entrySet().iterator();
        long l1;
        long l2;
        do
        {
          ...
          paramString = (Map.Entry)paramBitmap.next();
          this.b -= a((Bitmap)paramString.getValue());
          paramBitmap.remove();
          l1 = this.b;
          l2 = this.c;
        } while (l1 > l2);
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/lantern/push/a/c.class
