  ...
  extends a
{
  ...
  public aj(Context paramContext)
  {
    ...
    ((FrameLayout)localObject2).setOnClickListener(new ak(this));
    ...
    localObject1 = new FrameLayout.LayoutParams(o, n);
    ...
    ((RelativeLayout.LayoutParams)localObject1).topMargin = d.a(this.d, 19.0F);
    ...
    this.j.setId(65542);
    localObject1 = new RelativeLayout.LayoutParams(-2, d.a(this.d, 30.0F));
    ((RelativeLayout.LayoutParams)localObject1).addRule(3, paramContext.getId());
  ...
  public final void b(g paramg)
  {
    if (paramg != null)
    {
      ...
      com.lantern.feed.a.aj.a();
      localTextView.setTextColor(com.lantern.feed.a.aj.e(paramg.f()));
      localTextView = this.q;
      com.lantern.feed.a.aj.a();
      localTextView.setBackgroundResource(com.lantern.feed.a.aj.f(paramg.f()));
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/lantern/feed/ui/aj.class
