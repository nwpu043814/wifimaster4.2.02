  ...
  extends a
{
  ...
  public av(Context paramContext)
  {
    ...
    this.g.setPadding(d.a(this.d, 2.0F), d.a(this.d, 9.0F), 0, 0);
    localObject1 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject1).addRule(3, this.f.getId());
    ((RelativeLayout.LayoutParams)localObject1).addRule(11);
    ((RelativeLayout.LayoutParams)localObject1).topMargin = d.a(this.d, 7.0F);
    ((RelativeLayout)localObject2).addView(this.g, (ViewGroup.LayoutParams)localObject1);
    this.j = new ai(this.d, false);
    localObject1 = new RelativeLayout.LayoutParams(-1, d.a(this.d, 16.0F));
    ((RelativeLayout.LayoutParams)localObject1).topMargin = d.a(this.d, 16.0F);
    ((RelativeLayout.LayoutParams)localObject1).addRule(3, this.f.getId());
    ((RelativeLayout.LayoutParams)localObject1).addRule(0, this.g.getId());
    ((RelativeLayout)localObject2).addView(this.j, (ViewGroup.LayoutParams)localObject1);
    localObject1 = new RelativeLayout.LayoutParams(-1, -2);
    ...
    ((RelativeLayout.LayoutParams)this.i.getLayoutParams()).topMargin = (d.a(this.d, 12.0F) - 2);
  }
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/lantern/feed/ui/av.class
