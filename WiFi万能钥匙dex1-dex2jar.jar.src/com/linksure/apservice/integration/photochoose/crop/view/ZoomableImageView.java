  ...
  implements ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  private void b()
  {
    ...
    for (float f1 = i2 - localRectF.right;; f1 = 0.0F)
    {
      if (localRectF.height() >= i1)
      {
        f2 = f3;
        ...
        if (localRectF.bottom < i1) {
          f2 = i1 - localRectF.bottom;
        }
      }
      if (localRectF.width() < i2) {
        f1 = i2 * 0.5F - localRectF.right + localRectF.width() * 0.5F;
      }
      if (localRectF.height() < i1) {
        f2 = i1 * 0.5F - localRectF.bottom + localRectF.height() * 0.5F;
      }
  ...
  public void onGlobalLayout()
  {
    ...
    if ((i4 > i2) && (i1 <= i3)) {}
    for (float f2 = i2 * 1.0F / i4;; f2 = 1.0F)
    {
      float f1 = f2;
      if (i1 > i3)
      {
      ...
      if (i4 > i2)
      {
        f2 = f1;
        if (i1 > i3) {
          f2 = Math.min(i4 * 1.0F / i2, 1.0F * i1 / i3);
        }
      }
      this.a = f2;
      this.e.postTranslate((i2 - i4) / 2, (i3 - i1) / 2);
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/linksure/apservice/integration/photochoose/crop/view/ZoomableImageView.class
