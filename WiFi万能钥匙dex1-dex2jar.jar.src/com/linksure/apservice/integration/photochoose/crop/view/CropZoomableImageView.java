  ...
  implements ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  public void onGlobalLayout()
  {
    ...
    for (;;)
    {
      ...
      float f1 = Math.max(i4 * 1.0F / i1, i4 * 1.0F / i2);
      this.c = f1;
      this.a = (this.c * 4.0F);
      this.b = (this.c * 2.0F);
      this.n = ((getHeight() - (getWidth() - this.m * 2)) / 2);
      this.g.postTranslate((i4 - i1) / 2, (i3 - i2) / 2);
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/linksure/apservice/integration/photochoose/crop/view/CropZoomableImageView.class
