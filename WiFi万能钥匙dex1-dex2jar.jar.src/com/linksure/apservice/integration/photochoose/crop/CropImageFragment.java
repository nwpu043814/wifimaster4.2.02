...
import com.linksure.apservice.integration.photochoose.crop.view.CropImageLayout;
  ...
  extends Fragment
{
  ...
  public android.view.View onCreateView(android.view.LayoutInflater paramLayoutInflater, android.view.ViewGroup paramViewGroup, android.os.Bundle paramBundle)
  {
    ...
    //   1: astore_3
    //   2: aload_1
    //   3: getstatic 96	com/linksure/apservice/R$layout:settings_crop_image	I
    //   6: aconst_null
    //   7: invokevirtual 102	android/view/LayoutInflater:inflate	(ILandroid/view/ViewGroup;)Landroid/view/View;
    //   10: astore 6
    //   12: aload_0
    //   13: aload 6
    //   15: getstatic 107	com/linksure/apservice/R$id:clip	I
    //   18: invokevirtual 113	android/view/View:findViewById	(I)Landroid/view/View;
    //   21: checkcast 115	com/linksure/apservice/integration/photochoose/crop/view/CropImageLayout
    //   24: putfield 117	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:g	Lcom/linksure/apservice/integration/photochoose/crop/view/CropImageLayout;
    //   27: aload_0
    //   28: getstatic 122	com/linksure/apservice/R$string:settings_photo_set_avatar	I
    //   31: invokevirtual 125	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:a	(I)V
    //   34: aload_0
    //   35: iconst_m1
    //   36: invokevirtual 128	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:b	(I)V
    //   39: new 130	bluefay/app/u
    //   42: dup
    //   43: aload_0
    //   44: invokevirtual 134	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:getActivity	()Landroid/app/Activity;
    ...
    //   54: sipush 1001
    //   57: iconst_0
    //   58: getstatic 140	com/linksure/apservice/R$string:settings_photo_use_crop	I
    //   61: invokeinterface 146 5 0
    //   66: getstatic 140	com/linksure/apservice/R$string:settings_photo_use_crop	I
    //   69: invokeinterface 152 2 0
    //   74: pop
    //   75: aload_0
    //   76: getstatic 154	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:a	I
    //   79: aload_1
    //   80: invokevirtual 157	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:a	(ILandroid/view/Menu;)Z
    //   83: pop
    //   84: aload_0
    //   85: getfield 28	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:e	Landroid/content/Context;
    ...
    //   111: putfield 179	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:i	I
    //   114: aload_0
    //   115: aload_2
    //   116: ldc -75
    ...
    //   124: putfield 189	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:h	Landroid/net/Uri;
    //   127: aload_1
    ...
    //   133: ifnonnull +7 -> 140
    //   136: aload_0
    //   137: invokevirtual 195	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:a	()V
    //   140: aload_0
    //   141: aload_2
    //   142: invokespecial 197	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:a	(Landroid/net/Uri;)I
    //   145: istore 4
    ...
    //   164: aload_0
    //   165: getfield 28	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:e	Landroid/content/Context;
    ...
    //   188: invokestatic 208	com/linksure/apservice/integration/photochoose/b/f:b	(Ljava/lang/String;)I
    //   191: istore 4
    //   193: aload_3
    //   194: astore_2
    //   195: iload 4
    ...
    //   263: aload_0
    //   264: getfield 117	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:g	Lcom/linksure/apservice/integration/photochoose/crop/view/CropImageLayout;
    //   267: aload_2
    //   268: invokevirtual 239	com/linksure/apservice/integration/photochoose/crop/view/CropImageLayout:a	(Landroid/graphics/Bitmap;)V
    //   271: aload_1
    //   272: invokestatic 51	com/linksure/apservice/integration/photochoose/crop/c:a	(Ljava/io/Closeable;)V
    //   275: aload 6
    //   277: areturn
    //   278: astore_2
    //   279: aload_3
    ...
    //   285: aload_1
    //   286: invokestatic 51	com/linksure/apservice/integration/photochoose/crop/c:a	(Ljava/io/Closeable;)V
    //   289: goto -14 -> 275
    //   292: astore_2
    //   293: aconst_null
    //   294: astore_1
    //   295: aload_1
    //   296: invokestatic 51	com/linksure/apservice/integration/photochoose/crop/c:a	(Ljava/io/Closeable;)V
    //   299: aload_2
    //   300: athrow
    //   301: astore_2
    //   302: goto -7 -> 295
  ...
  public boolean onOptionsItemSelected(android.view.MenuItem paramMenuItem)
  {
    ...
    //   29: ireturn
    //   30: aload_0
    //   31: getfield 189	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:h	Landroid/net/Uri;
    //   34: ifnull +131 -> 165
    //   37: aconst_null
    //   38: astore_2
    //   39: aload_0
    //   40: getfield 28	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:e	Landroid/content/Context;
    //   43: invokevirtual 34	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   46: aload_0
    //   47: getfield 189	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:h	Landroid/net/Uri;
    ...
    //   60: astore_3
    //   61: aload_0
    //   62: getfield 117	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:g	Lcom/linksure/apservice/integration/photochoose/crop/view/CropImageLayout;
    //   65: invokevirtual 258	com/linksure/apservice/integration/photochoose/crop/view/CropImageLayout:a	()Landroid/graphics/Bitmap;
    //   68: astore 6
    //   70: aload 4
    //   72: ifnull +88 -> 160
    //   75: aload 6
    ...
    //   89: astore_3
    //   90: aload_0
    //   91: getfield 179	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:i	I
    //   94: ifle +47 -> 141
    //   97: aload 6
    //   99: astore 5
    //   101: aload 4
    ...
    //   112: aload_0
    //   113: getfield 179	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:i	I
    ...
    //   125: aload 6
    //   127: aload_0
    //   128: getfield 179	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:i	I
    //   131: aload_0
    //   132: getfield 179	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:i	I
    //   135: iconst_1
    ...
    //   159: pop
    //   160: aload 4
    //   162: invokestatic 51	com/linksure/apservice/integration/photochoose/crop/c:a	(Ljava/io/Closeable;)V
    //   165: aload_0
    //   166: getfield 28	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:e	Landroid/content/Context;
    //   169: checkcast 159	bluefay/app/b
    //   172: invokevirtual 163	bluefay/app/b:getIntent	()Landroid/content/Intent;
    //   175: astore_2
    //   176: aload_0
    //   177: getfield 28	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:e	Landroid/content/Context;
    //   180: checkcast 159	bluefay/app/b
    //   183: iconst_m1
    //   184: aload_2
    //   185: invokevirtual 276	bluefay/app/b:setResult	(ILandroid/content/Intent;)V
    //   188: aload_0
    //   189: getfield 28	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:e	Landroid/content/Context;
    //   192: checkcast 159	bluefay/app/b
    //   195: iconst_m1
    //   196: iconst_m1
    //   197: invokevirtual 280	bluefay/app/b:overridePendingTransition	(II)V
    //   200: aload_0
    //   201: invokevirtual 195	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:a	()V
    //   204: goto -180 -> 24
    //   207: astore_3
    //   208: aload_2
    //   209: astore_3
    ...
    //   227: aload 4
    //   229: aload_0
    //   230: getfield 189	com/linksure/apservice/integration/photochoose/crop/CropImageFragment:h	Landroid/net/Uri;
    ...
    //   242: aload_2
    //   243: invokestatic 51	com/linksure/apservice/integration/photochoose/crop/c:a	(Ljava/io/Closeable;)V
    //   246: goto -81 -> 165
    //   249: astore_1
    //   250: aconst_null
    //   251: astore_3
    //   252: aload_3
    //   253: invokestatic 51	com/linksure/apservice/integration/photochoose/crop/c:a	(Ljava/io/Closeable;)V
    //   256: aload_1
    //   257: athrow
    //   258: astore_1
    //   259: goto -7 -> 252
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/linksure/apservice/integration/photochoose/crop/CropImageFragment.class
