  ...
  extends GestureDetector.SimpleOnGestureListener
{
  ...
  public final boolean onDoubleTap(MotionEvent paramMotionEvent)
  {
    ...
    PhotoView.u(this.a).set(f1, f2);
    PhotoView.v(this.a).set(f1, f2);
    PhotoView.w(this.a);
    PhotoView.x(this.a);
    if (PhotoView.y(this.a))
    {
      f2 = PhotoView.z(this.a);
      f1 = 1.0F;
      ...
      PhotoView.B(this.a).postScale(f1, f1, PhotoView.u(this.a).x, PhotoView.u(this.a).y);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      PhotoView.n(this.a).a(f2, f1);
      PhotoView.n(this.a).a();
      return false;
      f2 = PhotoView.z(this.a);
      f1 = PhotoView.A(this.a);
  ...
  public final boolean onFling(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    for (float f2 = 0.0F;; f2 = paramFloat1)
    {
      ...
      for (float f3 = 0.0F;; f3 = paramFloat2)
      {
        ...
        {
          localOverScroller.fling(i4, i2, i5, i3, j, k, m, n, i1, i);
          PhotoView.n(this.a).a();
            ...
            if (!PhotoView.k(this.a))
            {
              ...
              if (paramFloat2 < 0.0F)
              {
                ...
                if (PhotoView.o(this.a).top - paramFloat2 > PhotoView.t(this.a).top) {
                  paramFloat1 = PhotoView.b(this.a, PhotoView.o(this.a).top - PhotoView.t(this.a).top, paramFloat2);
                }
              }
              f1 = paramFloat1;
              if (paramFloat1 > 0.0F)
              {
                ...
                if (PhotoView.o(this.a).bottom - paramFloat1 < PhotoView.t(this.a).bottom) {
                  f1 = PhotoView.b(this.a, PhotoView.o(this.a).bottom - PhotoView.t(this.a).bottom, paramFloat1);
                }
              }
            }
            PhotoView.b(this.a).postTranslate(0.0F, -f1);
            PhotoView.f(this.a, f1);
            PhotoView.b(this.a, true);
          }
        }
      }
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/linksure/apservice/ui/profile/widget/m.class
