...
public final class h
{
  ...
  private static g a(String paramString, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramObject = g.a(localJSONObject);
        ((g)paramObject).i = paramString;
        if (localJSONObject.has("cts"))
        {
          ((g)paramObject).j = localJSONObject.getLong("cts");
          paramString = (String)paramObject;
          return paramString;
        }
        try
        {
          ((g)paramObject).j = Long.parseLong(paramString);
          paramString = (String)paramObject;
        }
  ...
  public final List<g> a()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        localObject2 = new com/wifi/connect/c/i;
      }
      finally {}
  ...
  public final boolean a(g paramg)
  {
    ...
    //   28: lstore_3
    //   29: aload_0
    //   30: getfield 15	com/wifi/connect/c/h:b	Landroid/content/Context;
    //   33: aload_0
    //   34: getfield 19	com/wifi/connect/c/h:a	Ljava/lang/String;
    //   37: iconst_0
    ...
    //   54: aload_1
    //   55: invokevirtual 159	com/wifi/connect/model/g:toString	()Ljava/lang/String;
  ...
  public final boolean a(String paramString)
  {
    try
    {
      com.bluefay.b.h.a("key:%s", new Object[] { paramString });
...
/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/wifi/connect/c/h.class
