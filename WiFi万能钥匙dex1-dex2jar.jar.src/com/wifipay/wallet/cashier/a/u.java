...
public class u
  extends a
{
  public u(SuperActivity paramSuperActivity, StartPayParams paramStartPayParams, PayListener paramPayListener)
  {
  ...
  private void a(TransConfirm3Resp paramTransConfirm3Resp)
  {
    ...
    for (;;)
    {
      ...
      {
        this.b.additionalParams.put("orderId", paramTransConfirm3Resp.resultObject.orderId);
        BackgroundExecutor.a(new w(this));
      }
      else
      {
        this.c.d();
  ...
  public void a(BindCardPreSignResp paramBindCardPreSignResp)
  {
    ...
    if (ResponseCode.SUCCESS.getCode().equals(paramBindCardPreSignResp.resultCode))
    {
      ...
      this.b.type = CashierType.TRANSFER.getType();
      a();
    }
    for (;;)
    {
  ...
  public void a(String paramString)
  {
    super.a(paramString);
    this.c.c("");
    BackgroundExecutor.a(new v(this));
  }
}


/* Location:              /Users/hanlian/Downloads/WiFi万能钥匙dex1-dex2jar.jar!/com/wifipay/wallet/cashier/a/u.class
